...
from classes.exceptions import InvalidIPFSHashException, AccessDeniedException, UnKnownFileTypeException, \
    UnSupportedFileException
from classes.utils import ipfs_connect
from config import *
...
class IPFSDocument:
    ...
    def download_pinned_ipfs_document_into_cache(self):
        ...
        if not self._is_document_pinned():
            msg = "%s document is not pinned in the ipfs node." % self.hash
            logging.error(msg)
